...
class NatalAspects():
    ...
    def asp_calc(self, point_one, point_two):
        ...
        if int(distance) <= self.aspects_settings[0]['orb']:
            ...
            aspectSymbol = self.aspects_settings[0]['aspectSymbol']
            ...
            aspectSymbol = self.aspects_settings[1]['aspectSymbol']
            ...
            aspectSymbol = self.aspects_settings[2]['aspectSymbol']
            ...
            aspectSymbol = self.aspects_settings[3]['aspectSymbol']
            ...
            aspectSymbol = self.aspects_settings[4]['aspectSymbol']
            ...
            aspectSymbol = self.aspects_settings[5]['aspectSymbol']
            ...
            aspectSymbol = self.aspects_settings[6]['aspectSymbol']
            ...
            aspectSymbol = self.aspects_settings[7]['aspectSymbol']
            ...
            aspectSymbol = self.aspects_settings[8]['aspectSymbol']
            ...
            aspectSymbol = self.aspects_settings[9]['aspectSymbol']
            ...
            aspectSymbol = self.aspects_settings[10]['aspectSymbol']
        ...
        return verdict, name, aspectSymbol, distance - aspect_degrees, aspect_degrees, color, aid, diff
    ...
    def get_all_aspects(self):
        ...
        for first in range(len(point_list)):
            ...
            for second in range(first + 1, len(point_list)):
                ...
                verdict, name, aspectSymbol, orbit, aspect_degrees, color, aid, diff = self.asp_calc(point_list[first]["abs_pos"],
                                                                                                     point_list[second]["abs_pos"])

                if verdict == True:
                    d_asp = {"p1_name": point_list[first]['name'],
                             "p1_symbol": point_list[first]['planet_symbol'],
                             "p1_abs_pos": point_list[first]['abs_pos'],
                             "p2_name": point_list[second]['name'],
                             "p2_symbol": point_list[second]['planet_symbol'],
    ...
    def get_all_aspects(self):
        ...
        for first in range(len(f_1)):
            ...
            for second in range(len(f_2)):
                ...
                verdict, name, aspectSymbol, orbit, aspect_degrees, color, aid, diff = self.asp_calc(f_1[first]["abs_pos"],
                                                                                                     f_2[second]["abs_pos"])

                if verdict == True:
                    d_asp = {"p1_name": f_1[first]['name'],
                             "p1_symbol": f_1[first]['planet_symbol'],
                             "p1_abs_pos": f_1[first]['abs_pos'],
                             "p2_name": f_2[second]['name'],
                             "p2_symbol": f_2[second]['planet_symbol'],
