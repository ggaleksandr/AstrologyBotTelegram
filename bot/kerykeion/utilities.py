...
from .typesKerykeion import KerykeionPoint, KerykeionException
...
def calculate_position(degree: Union[int, float], number_name: str, planet_symbol: str, name_rus: str, point_type: Literal["Planet", "House"]) -> KerykeionPoint:
    ...
    if degree < 30:
        dictionary = {"name": number_name, "quality": "Cardinal", "element":
                      ...
                      "sign_symbol": u"\u2648", "planet_symbol": planet_symbol, "name_rus": name_rus, "emoji": "♈️", "aspectsSymbol": "", "point_type": point_type}
